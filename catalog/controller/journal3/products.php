	...
	private function parseProducts($results) {
		...
		foreach ($results as $result) {
			...
			$products[$result['product_id']] = array(
				...
				'thumb'          => $image,
				'name'           => $result['name'],
				'description'    => \Journal3\Utils\Str::utf8_substr(trim(strip_tags(html_entity_decode($result['description'], ENT_QUOTES, 'UTF-8'))), 0, (int)$this->settings['moduleProductDescriptionLimit']) . '..',
