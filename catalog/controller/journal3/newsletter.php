...
class ControllerJournal3Newsletter extends ModuleController {
	...
	public function newsletter() {
		try {
			...
			if (!$this->index(array('module_id' => $module_id, 'module_type' => 'newsletter', 'return_settings' => true))) {
			...
			if ((\Journal3\Utils\Str::utf8_strlen($email) > 96) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
