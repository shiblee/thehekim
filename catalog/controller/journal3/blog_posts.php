	...
	private function parsePosts($results) {
		...
		foreach ($results as $result) {
			...
			$posts[$result['post_id']] = array(
				...
				'description' => \Journal3\Utils\Str::utf8_substr(strip_tags(html_entity_decode($result['description'], ENT_QUOTES, 'UTF-8')), 0, (int)$this->journal3->settings->get('blogPostsDescriptionLimit')) . '..',
