...
class ModelJournal3Settings extends \Journal3\Opencart\Model {
	...
	public function getSettings() {
		...
		$results['dashboard_user'] = Arr::get($results, 'dashboard_user_' . $this->config->get('config_store_id'), '');
		$results['dashboard_key'] = Arr::get($results, 'dashboard_key_' . $this->config->get('config_store_id'), '');
