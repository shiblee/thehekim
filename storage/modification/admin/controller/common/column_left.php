...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$data['menus'][] = array(
			'id'       => 'menu-contact-messages',
			'icon'     => 'fa-envelope',
			'name'     => 'Contact Messages',
			'href'     => $this->url->link('contact/message', 'user_token=' . $this->session->data['user_token'], true),
			'children' => array()
		);
		    ...
		    'name'     => 'Manage Team',
		    'href'     => $this->url->link('extension/module/manage_team', 'user_token=' . $this->session->data['user_token'], true),
		    'children' => array()
		);
			...
			/* Admin Side  menu */						
			$adminmenus = array();		
			if ($this->user->hasPermission('access', 'extension/payment/razorpay')) {	
				$adminmenus[] = array(
					'name'	   => 'Plans',
					'href'     => $this->url->link('extension/payment/razorpay/getPlan', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
            ...
            if ($this->user->hasPermission('access', 'extension/payment/razorpay')) {		
				$adminmenus[] = array(
					'name'	   => 'Subscriptions',
					'href'     => $this->url->link('extension/payment/razorpay/getSubscription', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);					
