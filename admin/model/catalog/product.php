...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		foreach ($data['product_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_description SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "',dosage = '" . $this->db->escape($value['dosage']) . "', short_description = '" . $this->db->escape($value['short_description']) . "', main_ingredients = '" . $this->db->escape($value['main_ingredients']) . "', key_features = '" . $this->db->escape($value['key_features']) . "', faq_description = '" . $this->db->escape($value['faq_description']) . "', tag = '" . $this->db->escape($value['tag']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
